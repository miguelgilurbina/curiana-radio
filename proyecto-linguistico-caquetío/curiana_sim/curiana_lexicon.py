...
VOCABULARIO_BASE: dict[str, dict] = {
    ...
    "tara":       {"sig": "venado, ciervo (Odocoileus virginianus)",       "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "D10 (2026-08-03), grupo 2 — CONFLICTO DE GLOSA ABIERTO, la entrada NO se reescribe. La glosa activa («venado, ciervo») no tiene fuente localizada: no está en Zavala Reyes 2015, ni en van Buurt 2014, ni como lema en Alvarado 1921. En contra hay DOS fuentes independientes que coinciden: Zavala Reyes 2015 glosario #238 (HB+PMA+AM) «Langosta, mariposa», y Alvarado 1921 p.283, donde tara vale polilla o mariposa (cf. TARÍTA, «mariposa o tara pequeña»). Es el más fuerte de los tres conflictos y el único con doble corroboración. No se toca aquí porque la lectura de venado sostiene material del corpus ecológico (cultura/ecologia.yaml, ensayo 02 §10.6, diseño 02): corregirla obliga a tocar el canon, y eso es decisión de Miguel"},
