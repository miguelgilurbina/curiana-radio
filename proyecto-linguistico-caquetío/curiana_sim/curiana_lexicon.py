...
VOCABULARIO_BASE: dict[str, dict] = {
    ...
    "buco":       {"sig": "represa, presa de agua, reservorio",             "cat": "sust",  "fuente": "caquetío", "notas": "Zavala Reyes 2015, glosario #46 (AM+CGB): «Chorro de agua, presa de agua»; Alvarado 1921, p.34 s.v. BUCO: «caz, acequia» [atribución débil de la filiación: Alvarado la localiza en Lara y sugiere origen romance, confirma la glosa pero duda del origen indígena]"},
    ...
    "chiriguare": {"sig": "gavilán, ave rapaz grande",                      "cat": "sust",  "fuente": "caquetío", "notas": "Zavala Reyes 2015, glosario #84 (HB): «Gavilán» [atribución débil: voz zoonímica panvenezolana]"},
    ...
    "corie":      {"sig": "choza, habitación, espacio propio",              "cat": "sust",  "fuente": "caquetío", "notas": "D10 (2026-08-03), grupo 2 — CONFLICTO DE GLOSA ABIERTO, la entrada NO se reescribe. La glosa activa («choza, habitación») no tiene fuente localizada: ausente de Alvarado 1921 (ni lema ni mención) y de van Buurt 2014. En contra, Zavala Reyes 2015 glosario #90 (HB) «Armadillo» — y el propio CANON del proyecto ya dice armadillo: cultura/genealogia.yaml da «corie (armadillo)» como tótem del linaje Paugis, y la ficha de Buio-sha usa «corie (armadillo) como elogio». Es decir: la glosa del lexicón contradice a la fuente Y a su propio canon a la vez. No se toca aquí porque corie da nombre a Corie-ko"},
    "saruro":     {"sig": "árbol saruro (frutos pequeños)",                 "cat": "sust",  "fuente": "caquetío", "notas": "D10 (2026-08-03), grupo 2 — CONFLICTO DE GLOSA ABIERTO, la entrada NO se reescribe. La glosa activa («árbol saruro») no tiene fuente localizada: Alvarado 1921 no la trae ni como lema ni como mención, van Buurt 2014 no la tiene, Gatschet tampoco. Su único rastro en el repo es una lista de Notion (Venezolanismos de Origen Indígena) citada en DISENO_KOINE §8, y allí se usa para confirmar la terminación -aro/-uro, NO para sostener la glosa. En contra: Zavala Reyes 2015 glosario #224 (E) «Serpiente no venenosa. Boa constrictora». No se toca aquí porque saruro da nombre a la agente Saruro-sha y aparece en el vocabulario de Shaboro"},
    "tuqueque":   {"sig": "lagartija pequeña, gecko",                       "cat": "sust",  "fuente": "caquetío", "notas": "Zavala Reyes 2015, glosario #257 (E+A+PMA): «Lagarto casero»; Alvarado 1921, p.300 s.v. TUQUEQUE (geco: Thecadactylus rapicaudus / Gonatodes albogularis); van Buurt 2014 §6 s.v. waltaca deriva el papiamento totèki de «tuqueque, tuteque, an Amerindian word used for geckos in Venezuela» [atribución débil: voz venezolana corriente, ninguna fuente la localiza en Coro]"},
    ...
    "curiana":    {"sig": "territorio de los caquetíos / lugar del cardón", "cat": "topón", "fuente": "caquetío", "notas": "Zavala Reyes 2015, nota al pie (4): «Curiana: territorio donde estaban asentados los caquetíos»"},
    ...
    "chacamba":   {"sig": "¿cómo? (pregunta de estado)",                    "cat": "interr","fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, p.73, citando a Arcaya (1995): «fórmula de saludo: chacamba cudanga (¿Cómo está usted?)», recogida a una anciana de Mitare. Es la única frase caquetía conservada"},
    "cudanga":    {"sig": "usted, vos (2da persona formal)",                "cat": "pron",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, p.73, citando a Arcaya (1995): «chacamba cudanga (¿Cómo está usted?)»"},
    "cudan":      {"sig": "servir, estar al servicio de",                   "cat": "v_raiz","fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, p.73, citando a Arcaya (1995): «cudan de cuté (para servir a usted)»; variante de 1905: «judan de cuteo»"},
    "cuté":       {"sig": "a usted, para usted (dativo formal)",            "cat": "pron",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, p.73, citando a Arcaya (1995): «cudan de cuté (para servir a usted)»"},
    ...
    "humocaro":   {"sig": "mujer bella, hermosa",                           "cat": "adj",   "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #159 (GC): «Mujer bella»"},
    "cazi":       {"sig": "sol",                                            "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #76 (GC): «Sol»"},
    ...
    "cazebo":     {"sig": "poniente, oeste",                                "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #75 (GC): «Poniente»"},
    "cazicure":   {"sig": "levante, este",                                  "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #77 (GC): «Parte del levante»"},
    ...
    "guaitiao":   {"sig": "amigo ritual, aliado de alianza",                "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Oliver 1989, cap. 2, p.147, sobre Oviedo y Valdés: mismo lexema que datihao sobre la raíz de parentesco /-atti-/, con distinto prefijo de persona; el pacto de guaitiao (intercambio de nombres entre aliados) lo describe Oviedo para el área circuncaribe"},
    ...
    "dare":       {"sig": "diente; hijo (extensión metafórica)",            "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #103 (HB): «Diente»; Oliver 1989 la confirma en Paraguaná"},
    ...
    "cari":       {"sig": "orilla del mar, costa",                         "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #66 (E): «Orilla del mar»; Cruz Esteves 1989 vía van Buurt 2014 §9 (topónimo Cariatávo), cari/kari = costa, orilla"},
    "rao":        {"sig": "arena, arenal costero",                         "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #219 (E): «Arena»"},
    "barici":     {"sig": "agua turbia, tierras coloradas rojizas",         "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #34 (HB): «Agua turbia»"},
    "pariri":     {"sig": "pantano, ciénaga",                              "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #194 (AM): «Pantano, ciénaga»"},
    "tarica":     {"sig": "laguna, espejo de agua interior",               "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #242 (AM): «Laguna»"},
    "güique":     {"sig": "río navegable, cauce ancho",                    "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #152 (AM): «Río navegable»"},
    "quidi":      {"sig": "sierra, serranía, cerro largo",                 "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #212 (AM): «Cerro, altura»"},
    ...
    "buko":       {"sig": "canal de riego, acequia, presa",                "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #46 «Buco» (AM+CGB): «Chorro de agua, presa de agua» (misma palabra que buco, aquí con grafía k)"},
    "gua":        {"sig": "conuco, heredad, terreno cercado cultivado",    "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #122 (HP): «Conuco, heredad, terreno cercado con algo»"},
    ...
    "amaca":      {"sig": "sitio de moler maíz, área de procesamiento",    "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #9 (AM): «Sitio de moler maíz»"},
    ...
    "cazá":       {"sig": "puche de maíz, atole",                         "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #74 (HB): «Puche de maíz»"},
    "mazato":     {"sig": "bebida de harinas fermentada",                  "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Alvarado 1921, p.217 s.v. MAZATO, citando Oviedo II.297 y 300 («magato… brevaje») [atribución débil de la filiación: la forma es panamericana (masato peruano), la glosa sí está confirmada]"},
    "cumaragua":  {"sig": "caracol de las costas de Paraguaná",      "cat": "sust",  "fuente": "caquetío-atestiguado", "glosa_fuente": "Especie de caracol de las costas de Paraguaná [Alvarado 1921 p.102 s.v. CUMARAGUA]", "notas": "D10 (2026-08-03), grupo 2 — GLOSA CORREGIDA, la palabra sigue siendo caquetía. Alvarado 1921 p.102 es la localización más precisa de todo su glosario para una voz de esta lista: costas de Paraguaná. PREMISA CORREGIDA: la glosa anterior NO estaba sin fuente. La lectura que se descarta —Zavala Reyes 2015 glosario #93 (HB+E) «Ciruela, espuma rosada», fuerza F, y Arcaya 1920 sobre la Relación de Barquisimeto 1579 («mene y cumaragua nombre de la ciruela»)— queda registrada aquí íntegra por D7. Las dos son fuentes históricas y ninguna es moderna: el conflicto es real y D10 adjudica por localización"},
    ...
    "güere":      {"sig": "dar, entregar, ofrecer",                        "cat": "v_raiz","fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #149 (AM): «Dar, entregar»"},
    "jacura":     {"sig": "guardar, conservar, custodiar",                 "cat": "v_raiz","fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #171 (AM): «Guardar»"},
    "jai":        {"sig": "oír, escuchar",                                 "cat": "v_raiz","fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #175 (AM): «Oír, escuchar»"},
    "jaguey":     {"sig": "estancar, represar, crear charco artificial",   "cat": "v_raiz","fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #174 (AM): «Establecer, estancar» [atribución débil: jagüey es panamericano, de origen taíno]"},
    "jacuque":    {"sig": "regar, irrigar",                                "cat": "v_raiz","fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #170 (AM): «Regar, regadío»"},
    ...
    "catarí":     {"sig": "cuatro",                                        "cat": "num",   "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #70 (PMA): «Número cuatro»"},
    ...
    "cachicamo":  {"sig": "armadillo (Dasypus novemcinctus)",              "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Alvarado 1921, p.41 s.v. CACHICAMO: glosa idéntica (Dasypus) [atribución débil de la filiación: voz de circulación nacional, Alvarado no declara origen ni la localiza en Coro]"},
    "caduchi":    {"sig": "fruto del cardón (Cereus spp.)",                "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #55 (HB): «Higo, breva» [atribución débil: la fuente da la glosa española del fruto, no el referente local (cardón)]"},
    ...
    "tara":       {"sig": "venado, ciervo (Odocoileus virginianus)",       "cat": "sust",  "fuente": "caquetío-atestiguado", "notas": "D10 (2026-08-03), grupo 2 — CONFLICTO DE GLOSA ABIERTO, la entrada NO se reescribe. La glosa activa («venado, ciervo») no tiene fuente localizada: no está en Zavala Reyes 2015, ni en van Buurt 2014, ni como lema en Alvarado 1921. En contra hay DOS fuentes independientes que coinciden: Zavala Reyes 2015 glosario #238 (HB+PMA+AM) «Langosta, mariposa», y Alvarado 1921 p.283, donde tara vale polilla o mariposa (cf. TARÍTA, «mariposa o tara pequeña»). Es el más fuerte de los tres conflictos. TERCERA CORROBORACIÓN (2026-08-04, minería de Jahn): Jahn 1927 p.213 n.29 lista las voces caquetías del Apéndice al tomo IV de Oviedo y Valdés, y entre ellas «tara, langosta». Es la atestación MÁS TEMPRANA de las tres (s. XVI, primaria) y es independiente de Zavala y de Alvarado. El conflicto pasa de doble a triple corroboración y ninguna fuente sostiene ya «venado». No se toca aquí porque la lectura de venado sostiene material del corpus ecológico (3-mundo/corpus/ecologia.yaml, ensayo 02 §10.6, diseño 02): corregirla obliga a tocar el canon, y eso es decisión de Miguel"},
    ...
    "bariki":     {"sig": "tierra colorada, pigmento encarnado, pintura corporal", "cat": "sust", "fuente": "caquetío-atestiguado", "notas": "Zavala Reyes 2015, glosario #35 «Barique» (AM+HB): «Arcilla roja. Almagre. Galeotto Cey indica Bariquizi o bija»; Arcaya la cita también en la Relación de Barquisimeto 1579"},
    "mene":       {"sig": "sustancia que brota de la tierra (petróleo, resina)",   "cat": "sust", "fuente": "caquetío-atestiguado", "notas": "Alvarado 1921, p.218 s.v. MÉNE, citando Oviedo II.301 («betún a manera de brea») y a Codazzi, que localiza los yacimientos en Coro y Maracaibo; Zavala Reyes 2015, p.62, cita a Arcaya (1920) sobre la Relación de Barquisimeto 1579 («mene y cumaragua nombre de la ciruela») [advertencia: la sintaxis de Arcaya es ambigua y esa cita NO sostiene la glosa de petróleo o rezumadero — quien la sostiene es Alvarado]"},
