...
VOCABULARIO_BASE: dict[str, dict] = {
    ...
    "pian": {"es": "dos (numeral)", "fuente": "caquetío-reconstruido", "notas": "Lok. bian → pian; Way. piama → piama; confianza media", "categoria": "gramatica"},
    "cabyn": {"es": "tres (numeral)", "fuente": "caquetío-reconstruido", "notas": "Lok. kabyn → cabyn; Way. apünüin → abunuin; confianza media", "categoria": "gramatica"},
    "pithi": {"es": "cuatro (numeral)", "fuente": "caquetío-reconstruido", "notas": "Lok. bithi → pithi; Way. pienchi → pienchi; confianza media", "categoria": "gramatica"},
    "peyiche": {"es": "bejique, chamán taíno, mediador ritual", "fuente": "caquetío-reconstruido", "notas": "Taíno bejique → peyiche; confianza media", "categoria": "cosmos"},
    "paraca": {"es": "mar, agua extensa (forma lokono)", "fuente": "caquetío-reconstruido", "notas": "Lok. baraha → paraca; confianza media", "categoria": "geografia"},
    "coïa": {"es": "tierra, suelo (forma lokono)", "fuente": "caquetío-reconstruido", "notas": "Lok. koïa → coïa; confianza media", "categoria": "geografia"},
    "puru": {"es": "cielo, firmamento", "fuente": "caquetío-reconstruido", "notas": "Lok. buru → puru; confianza media", "categoria": "cosmos"},
    "cassacu": {"es": "firmamento, bóveda celeste", "fuente": "caquetío-reconstruido", "notas": "Lok. kassaku → cassacu; confianza media", "categoria": "cosmos"},
    "colocon": {"es": "en el fuego, en la luz (postposición)", "fuente": "caquetío-reconstruido", "notas": "Lok. kolokon → colocon; confianza media", "categoria": "cosmos"},
    "tacuty": {"es": "pies, patas", "fuente": "caquetío-reconstruido", "notas": "Lok. dakuty → tacuty; confianza media", "categoria": "cuerpo"},
    "anucu": {"es": "boca", "fuente": "caquetío-reconstruido", "notas": "Lok. daliroko → taliroco; Way. aanükü → anucu; confianza media", "categoria": "cuerpo"},
    "tari": {"es": "dientes", "fuente": "caquetío-reconstruido", "notas": "Lok. dari → tari; confianza media", "categoria": "cuerpo"},
    "ucu": {"es": "corazón, centro vital", "fuente": "caquetío-reconstruido", "notas": "Lok. ukku → ucu; confianza media", "categoria": "cuerpo"},
    "ucurahu2": {"es": "pus (secreción del cuerpo enfermo)", "fuente": "caquetío-reconstruido", "notas": "Lok. ukkurahu2 → ucurahu2; confianza media", "categoria": "cuerpo"},
    "eichi": {"es": "nariz", "fuente": "caquetío-reconstruido", "notas": "Lok. wasiri → wasiri; Way. e'ichi → eichi; Taíno aduri → aduri; confianza media", "categoria": "cuerpo"},
    "poro": {"es": "aldea, pueblo, asentamiento", "fuente": "caquetío-reconstruido", "notas": "Lok. boro → poro; confianza media", "categoria": "geografia"},
    "capojan": {"es": "conuco, milpa, terreno de cultivo", "fuente": "caquetío-reconstruido", "notas": "Lok. kabojan → capojan; confianza media", "categoria": "geografia"},
    "cairi": {"es": "isla, territorio insular", "fuente": "caquetío-reconstruido", "notas": "Lok. kairi → cairi; confianza media", "categoria": "geografia"},
    "oniapo": {"es": "agua, cuerpo de agua", "fuente": "caquetío-reconstruido", "notas": "Lok. oniabo → oniapo; confianza media", "categoria": "geografia"},
    "salapan": {"es": "sabana, llanura (terreno plano y liso)", "fuente": "caquetío-reconstruido", "notas": "Lok. sallaban → salapan; confianza media", "categoria": "geografia"},
    "sipa": {"es": "piedra, roca", "fuente": "caquetío-reconstruido", "notas": "Lok. siba → sipa; confianza media", "categoria": "geografia"},
    "apa": {"es": "uno, un (numeral y artículo indefinido)", "fuente": "caquetío-reconstruido", "notas": "Lok. aba → apa; confianza media", "categoria": "gramatica"},
    "alican": {"es": "quién (interrogativo)", "fuente": "caquetío-reconstruido", "notas": "Lok. alikan → alican; confianza media", "categoria": "gramatica"},
    "anacan": {"es": "centro, punto medio (concepto espacial)", "fuente": "caquetío-reconstruido", "notas": "Lok. annakan → anacan; confianza media", "categoria": "gramatica"},
    "pe": {"es": "sufijo plural general (-be)", "fuente": "caquetío-reconstruido", "notas": "Lok. be → pe; confianza media", "categoria": "gramatica"},
    "pi": {"es": "tú (pronombre libre 2sg)", "fuente": "caquetío-reconstruido", "notas": "Lok. bi → pi; confianza media", "categoria": "gramatica"},
    "piinasufix": {"es": "sufijo de pasado próximo (-biina: ayer)", "fuente": "caquetío-reconstruido", "notas": "Lok. biinasufix → piinasufix; confianza media", "categoria": "gramatica"},
    "pisufix": {"es": "sufijo de pasado reciente (-bi: hoy)", "fuente": "caquetío-reconstruido", "notas": "Lok. bisufix → pisufix; confianza media", "categoria": "gramatica"},
    "pute": {"es": "ahora (marcador de presente inmediato)", "fuente": "caquetío-reconstruido", "notas": "Lok. bute → pute; confianza media", "categoria": "gramatica"},
    "te": {"es": "yo (pronombre libre 1sg)", "fuente": "caquetío-reconstruido", "notas": "Lok. de → te; confianza media", "categoria": "gramatica"},
    "toma": {"es": "porque, a causa de (postposición causal)", "fuente": "caquetío-reconstruido", "notas": "Lok. doma → toma; confianza media", "categoria": "gramatica"},
    "ipin": {"es": "ya, de ya (aspecto completivo)", "fuente": "caquetío-reconstruido", "notas": "Lok. hibin → ipin; confianza media", "categoria": "gramatica"},
    "cen": {"es": "y (conjunción copulativa)", "fuente": "caquetío-reconstruido", "notas": "Lok. ken → cen; confianza media", "categoria": "gramatica"},
    "cijadoma": {"es": "por eso, por tanto, por esa razón", "fuente": "caquetío-reconstruido", "notas": "Lok. kijadoma → cijadoma; confianza media", "categoria": "gramatica"},
    "lico": {"es": "nuestro (posesivo 1pl, poseído)", "fuente": "caquetío-reconstruido", "notas": "Lok. liko → lico; confianza media", "categoria": "gramatica"},
    "pocithi": {"es": "hermano mayor (visto por el menor)", "fuente": "caquetío-reconstruido", "notas": "Lok. bokithi → pocithi; confianza media", "categoria": "parentesco"},
    "tali": {"es": "padre (mi padre, forma poseída)", "fuente": "caquetío-reconstruido", "notas": "Lok. dalli → tali; confianza media", "categoria": "parentesco"},
    "ipili": {"es": "niño, infante (sin distinción de género)", "fuente": "caquetío-reconstruido", "notas": "Lok. ibili → ipili; confianza media", "categoria": "parentesco"},
    "cakythi": {"es": "hombre adulto arahuacano", "fuente": "caquetío-reconstruido", "notas": "Lok. kakythi → cakythi; confianza media", "categoria": "parentesco"},
    "cakythinon": {"es": "pueblo, gente arahuacana", "fuente": "caquetío-reconstruido", "notas": "Lok. kakythinon → cakythinon; confianza media", "categoria": "parentesco"},
    "cupacanan": {"es": "antepasados, ancestros", "fuente": "caquetío-reconstruido", "notas": "Lok. kubakanan → cupacanan; confianza media", "categoria": "parentesco"},
    "lucunu": {"es": "el pueblo lokono (autónimo colectivo)", "fuente": "caquetío-reconstruido", "notas": "Lok. lukkunu → lucunu; confianza media", "categoria": "parentesco"},
    "ocithi": {"es": "hermano menor (visto por el mayor)", "fuente": "caquetío-reconstruido", "notas": "Lok. okithi → ocithi; confianza media", "categoria": "parentesco"},
    "ocitho": {"es": "hermana menor (vista por la mayor)", "fuente": "caquetío-reconstruido", "notas": "Lok. okitho → ocitho; confianza media", "categoria": "parentesco"},
    "ucurahu": {"es": "familia, tribu, grupo de origen común", "fuente": "caquetío-reconstruido", "notas": "Lok. ukkurahu → ucurahu; confianza media", "categoria": "parentesco"},
    "awothici": {"es": "encontrar, hallar", "fuente": "caquetío-reconstruido", "notas": "Lok. awothiki → awothici; confianza media", "categoria": "verbos"},
    "pocon": {"es": "cocinar, hervir", "fuente": "caquetío-reconstruido", "notas": "Lok. bokon → pocon; confianza media", "categoria": "verbos"},
    "poratyn": {"es": "ayudar, salvar", "fuente": "caquetío-reconstruido", "notas": "Lok. boratyn → poratyn; confianza media", "categoria": "verbos"},
    "tian": {"es": "hablar, decir", "fuente": "caquetío-reconstruido", "notas": "Lok. dian → tian; confianza media", "categoria": "verbos"},
    "ayata": {"es": "golpear, pegar", "fuente": "caquetío-reconstruido", "notas": "Lok. fatadyn → fatadyn; Way. ajataa → ayata; confianza media", "categoria": "verbos"},
    "cassan": {"es": "estar embarazada", "fuente": "caquetío-reconstruido", "notas": "Lok. kassan → cassan; confianza media", "categoria": "verbos"},
    "sicin": {"es": "dar, poner", "fuente": "caquetío-reconstruido", "notas": "Lok. sikin → sicin; confianza media", "categoria": "verbos"},
    "socon": {"es": "cortar (con machete o hacha)", "fuente": "caquetío-reconstruido", "notas": "Lok. sokon → socon; confianza media", "categoria": "verbos"},
    "aayula": {"es": "calor, temperatura", "fuente": "caquetío-reconstruido", "notas": "Way. aa'ayula → aayula; confianza media", "categoria": "cosmos"},
    "amusain": {"es": "humo", "fuente": "caquetío-reconstruido", "notas": "Way. amüsain → amusain; confianza media", "categoria": "cosmos"},
    "aturula": {"es": "trueno, paso", "fuente": "caquetío-reconstruido", "notas": "Way. atürüla → aturula; confianza media", "categoria": "cosmos"},
    "auarala": {"es": "luz", "fuente": "caquetío-reconstruido", "notas": "Way. awarala → auarala; confianza media", "categoria": "cosmos"},
    "aya": {"es": "relámpago", "fuente": "caquetío-reconstruido", "notas": "Way. ayaa → aya; confianza media", "categoria": "cosmos"},
    "emiouchi": {"es": "sombra", "fuente": "caquetío-reconstruido", "notas": "Way. eemioushi → emiouchi; confianza media", "categoria": "cosmos"},
    "olotsu": {"es": "estrella", "fuente": "caquetío-reconstruido", "notas": "Way. jolotsü → olotsu; confianza media", "categoria": "cosmos"},
    "caspoluin": {"es": "arco iris", "fuente": "caquetío-reconstruido", "notas": "Way. kaspolüin → caspoluin; confianza media", "categoria": "cosmos"},
    "catcousu": {"es": "arma de fuego", "fuente": "caquetío-reconstruido", "notas": "Way. katkousü → catcousu; confianza media", "categoria": "cosmos"},
    "palii": {"es": "ceniza", "fuente": "caquetío-reconstruido", "notas": "Way. pali'i → palii; confianza media", "categoria": "cosmos"},
    "piyuuchi": {"es": "oscuridad", "fuente": "caquetío-reconstruido", "notas": "Way. piyuushi → piyuuchi; confianza media", "categoria": "cosmos"},
    "balatchi": {"es": "calor atmosférico", "fuente": "caquetío-reconstruido", "notas": "Way. walatshi → balatchi; confianza media", "categoria": "cosmos"},
    "bauai": {"es": "viento (de tempestad)", "fuente": "caquetío-reconstruido", "notas": "Way. wawai → bauai; confianza media", "categoria": "cosmos"},
    "auala": {"es": "cabello", "fuente": "caquetío-reconstruido", "notas": "Way. a'wala → auala; confianza media", "categoria": "cuerpo"},
    "auiira": {"es": "lágrima", "fuente": "caquetío-reconstruido", "notas": "Way. a'wiira → auiira; confianza media", "categoria": "cuerpo"},
    "aluuain": {"es": "tobillo", "fuente": "caquetío-reconstruido", "notas": "Way. aaluwain → aluuain; confianza media", "categoria": "cuerpo"},
    "achaa": {"es": "excremento", "fuente": "caquetío-reconstruido", "notas": "Way. acha'a → achaa; confianza media", "categoria": "cuerpo"},
    "achee": {"es": "oreja, oído", "fuente": "caquetío-reconstruido", "notas": "Way. ache'e → achee; confianza media", "categoria": "cuerpo"},
    "achebu": {"es": "pintura para la cara", "fuente": "caquetío-reconstruido", "notas": "Way. achepü → achebu; confianza media", "categoria": "cuerpo"},
    "ayapcii": {"es": "muñeca", "fuente": "caquetío-reconstruido", "notas": "Way. ajapkii → ayapcii; confianza media", "categoria": "cuerpo"},
    "aluuuain": {"es": "pecho", "fuente": "caquetío-reconstruido", "notas": "Way. aluuwain → aluuuain; confianza media", "categoria": "cuerpo"},
    "amulira": {"es": "vello", "fuente": "caquetío-reconstruido", "notas": "Way. amülira → amulira; confianza media", "categoria": "cuerpo"},
    "abachera": {"es": "dedo (del pie)", "fuente": "caquetío-reconstruido", "notas": "Way. apachera → abachera; confianza media", "categoria": "cuerpo"},
    "abatou": {"es": "uña, garra, pezuña", "fuente": "caquetío-reconstruido", "notas": "Way. apato'u → abatou; confianza media", "categoria": "cuerpo"},
    "abuu": {"es": "muslo", "fuente": "caquetío-reconstruido", "notas": "Way. apü'ü → abuu; confianza media", "categoria": "cuerpo"},
    "asabu": {"es": "espalda, columna", "fuente": "caquetío-reconstruido", "notas": "Way. asapü → asabu; confianza media", "categoria": "cuerpo"},
    "aseeruu": {"es": "mitad, cintura", "fuente": "caquetío-reconstruido", "notas": "Way. ase'eru'u → aseeruu; confianza media", "categoria": "cuerpo"},
    "asibala": {"es": "cicatriz", "fuente": "caquetío-reconstruido", "notas": "Way. asipala → asibala; confianza media", "categoria": "cuerpo"},
    "atuna": {"es": "brazo, ala", "fuente": "caquetío-reconstruido", "notas": "Way. atüna → atuna; confianza media", "categoria": "cuerpo"},
    "aua": {"es": "saliva", "fuente": "caquetío-reconstruido", "notas": "Way. awaa → aua; confianza media", "categoria": "cuerpo"},
    "auala-2": {"es": "hermano, -na", "fuente": "caquetío-reconstruido", "notas": "Way. awala → auala; confianza media", "categoria": "cuerpo"},
    "aualainse": {"es": "mandíbula, quijada", "fuente": "caquetío-reconstruido", "notas": "Way. awalainse → aualainse; confianza media", "categoria": "cuerpo"},
    "aualabaa": {"es": "mejilla", "fuente": "caquetío-reconstruido", "notas": "Way. awalapa'a → aualabaa; confianza media", "categoria": "cuerpo"},
    "aye": {"es": "lengua", "fuente": "caquetío-reconstruido", "notas": "Way. ayee → aye; confianza media", "categoria": "cuerpo"},
    "ayulain": {"es": "intestino, tripa", "fuente": "caquetío-reconstruido", "notas": "Way. ayülain → ayulain; confianza media", "categoria": "cuerpo"},
    "eiima": {"es": "barba", "fuente": "caquetío-reconstruido", "notas": "Way. e'iima → eiima; confianza media", "categoria": "cuerpo"},
    "eiruu": {"es": "punta", "fuente": "caquetío-reconstruido", "notas": "Way. e'iru'u → eiruu; confianza media", "categoria": "cuerpo"},
    "eiyeise": {"es": "barbilla", "fuente": "caquetío-reconstruido", "notas": "Way. e'iyeise → eiyeise; confianza media", "categoria": "cuerpo"},
    "eyuu": {"es": "olor", "fuente": "caquetío-reconstruido", "notas": "Way. eejuu → eyuu; confianza media", "categoria": "cuerpo"},
    "eibuse": {"es": "hueso", "fuente": "caquetío-reconstruido", "notas": "Way. eipüse → eibuse; confianza media", "categoria": "cuerpo"},
    "ecia": {"es": "mano derecha", "fuente": "caquetío-reconstruido", "notas": "Way. ekia → ecia; confianza media", "categoria": "cuerpo"},
    "eciicholoin": {"es": "cerebro, seso", "fuente": "caquetío-reconstruido", "notas": "Way. ekiisholoin → eciicholoin; confianza media", "categoria": "cuerpo"},
    "ebee": {"es": "mano izquierda", "fuente": "caquetío-reconstruido", "notas": "Way. epe'e → ebee; confianza media", "categoria": "cuerpo"},
    "euein": {"es": "lunar", "fuente": "caquetío-reconstruido", "notas": "Way. ewein → euein; confianza media", "categoria": "cuerpo"},
    "calabuchou": {"es": "ave cucarachero", "fuente": "caquetío-reconstruido", "notas": "Way. ka'lapücho'u → calabuchou; confianza media", "categoria": "cuerpo"},
    "carai": {"es": "alcaraván (dara)", "fuente": "caquetío-reconstruido", "notas": "Way. kaarai → carai; confianza media", "categoria": "cuerpo"},
    "calecale": {"es": "perico (cara sucia)", "fuente": "caquetío-reconstruido", "notas": "Way. kalekale → calecale; confianza media", "categoria": "cuerpo"},
    "casiba": {"es": "ciempiés", "fuente": "caquetío-reconstruido", "notas": "Way. kasipa → casiba; confianza media", "categoria": "cuerpo"},
    "mayayulu": {"es": "señorita, joven (mujer)", "fuente": "caquetío-reconstruido", "notas": "Way. majayülü → mayayulu; confianza media", "categoria": "cuerpo"},
    "mabui": {"es": "piojo", "fuente": "caquetío-reconstruido", "notas": "Way. mapüi → mabui; confianza media", "categoria": "cuerpo"},
    "oulucu": {"es": "miembro", "fuente": "caquetío-reconstruido", "notas": "Way. o'uluku → oulucu; confianza media", "categoria": "cuerpo"},
    "oubuna": {"es": "cara, rostro", "fuente": "caquetío-reconstruido", "notas": "Way. o'upünaa → oubuna; confianza media", "categoria": "cuerpo"},
    "outala": {"es": "cáscara", "fuente": "caquetío-reconstruido", "notas": "Way. o'utala → outala; confianza media", "categoria": "cuerpo"},
    "omocoin": {"es": "espuma", "fuente": "caquetío-reconstruido", "notas": "Way. omokoin → omocoin; confianza media", "categoria": "cuerpo"},
    "balachi": {"es": "pelo", "fuente": "caquetío-reconstruido", "notas": "Way. walashi → balachi; confianza media", "categoria": "cuerpo"},
    "yoi": {"es": "llaga, infección", "fuente": "caquetío-reconstruido", "notas": "Way. yooi → yoi; confianza media", "categoria": "cuerpo"},
    "ayuna": {"es": "cubierta, techo", "fuente": "caquetío-reconstruido", "notas": "Way. aajuna → ayuna; confianza media", "categoria": "geografia"},
    "anoi": {"es": "terreno despejado", "fuente": "caquetío-reconstruido", "notas": "Way. anooi → anoi; confianza media", "categoria": "geografia"},
    "abule": {"es": "lugar, sitio, puesto", "fuente": "caquetío-reconstruido", "notas": "Way. apülee → abule; confianza media", "categoria": "geografia"},
    "abuna": {"es": "camino, sendero", "fuente": "caquetío-reconstruido", "notas": "Way. apüna → abuna; confianza media", "categoria": "geografia"},
    "asebu": {"es": "pared", "fuente": "caquetío-reconstruido", "notas": "Way. asepü → asebu; confianza media", "categoria": "geografia"},
    "atuu": {"es": "superficie interior", "fuente": "caquetío-reconstruido", "notas": "Way. atu'u → atuu; confianza media", "categoria": "geografia"},
    "iba": {"es": "piedra", "fuente": "caquetío-reconstruido", "notas": "Way. ipa → iba; confianza media", "categoria": "geografia"},
    "culala": {"es": "corral", "fuente": "caquetío-reconstruido", "notas": "Way. kulaala → culala; confianza media", "categoria": "geografia"},
    "la": {"es": "jagüey", "fuente": "caquetío-reconstruido", "notas": "Way. laa → la; confianza media", "categoria": "geografia"},
    "luuobu": {"es": "arroyo", "fuente": "caquetío-reconstruido", "notas": "Way. luwopu → luuobu; confianza media", "categoria": "geografia"},
    "maraya": {"es": "vidrio", "fuente": "caquetío-reconstruido", "notas": "Way. maraaja → maraya; confianza media", "categoria": "geografia"},
    "miirocu": {"es": "sitio donde hay", "fuente": "caquetío-reconstruido", "notas": "Way. miiroku → miirocu; confianza media", "categoria": "geografia"},
    "moyuui": {"es": "monte (vegetación)", "fuente": "caquetío-reconstruido", "notas": "Way. mojuui → moyuui; confianza media", "categoria": "geografia"},
    "namuna": {"es": "loma, cerro", "fuente": "caquetío-reconstruido", "notas": "Way. namüna → namuna; confianza media", "categoria": "geografia"},
    "puattou": {"es": "puerta", "fuente": "caquetío-reconstruido", "notas": "Way. puatto'u → puattou; confianza media", "categoria": "geografia"},
    "boolu": {"es": "mochila para el cinturón bosque, monte", "fuente": "caquetío-reconstruido", "notas": "Way. wo'olu → boolu; confianza media", "categoria": "geografia"},
    "buin": {"es": "agua", "fuente": "caquetío-reconstruido", "notas": "Way. wüin → buin; confianza media", "categoria": "geografia"},
    "aaca": {"es": "entre", "fuente": "caquetío-reconstruido", "notas": "Way. a'aka → aaca; confianza media", "categoria": "gramatica"},
    "aatou": {"es": "al lado de", "fuente": "caquetío-reconstruido", "notas": "Way. a'ato'u → aatou; confianza media", "categoria": "gramatica"},
    "autpaa": {"es": "al lado de, junto a", "fuente": "caquetío-reconstruido", "notas": "Way. a'ütpa'a → autpaa; confianza media", "categoria": "gramatica"},
    "au": {"es": "en", "fuente": "caquetío-reconstruido", "notas": "Way. aa'u → au; confianza media", "categoria": "gramatica"},
    "achin": {"es": "según", "fuente": "caquetío-reconstruido", "notas": "Way. aashin → achin; confianza media", "categoria": "gramatica"},
    "achiciye": {"es": "después de", "fuente": "caquetío-reconstruido", "notas": "Way. achikijee → achiciye; confianza media", "categoria": "gramatica"},
    "achiciruu": {"es": "después de la salida aikkaa", "fuente": "caquetío-reconstruido", "notas": "Way. achikiru'u → achiciruu; confianza media", "categoria": "gramatica"},
    "airuu": {"es": "en la horqueta de, entre", "fuente": "caquetío-reconstruido", "notas": "Way. airu'u → airuu; confianza media", "categoria": "gramatica"},
    "acaisaa": {"es": "pero, sin embargo", "fuente": "caquetío-reconstruido", "notas": "Way. akaisa'a → acaisaa; confianza media", "categoria": "gramatica"},
    "aleeruu": {"es": "en el vientre de", "fuente": "caquetío-reconstruido", "notas": "Way. ale'eru'u → aleeruu; confianza media", "categoria": "gramatica"},
    "aluu": {"es": "dentro de, en", "fuente": "caquetío-reconstruido", "notas": "Way. alu'u → aluu; confianza media", "categoria": "gramatica"},
    "aluuyasaa": {"es": "pero", "fuente": "caquetío-reconstruido", "notas": "Way. alu'ujasa'a → aluuyasaa; confianza media", "categoria": "gramatica"},
    "amaichici": {"es": "antes", "fuente": "caquetío-reconstruido", "notas": "Way. ama'ichiki → amaichici; confianza media", "categoria": "gramatica"},
    "amainruu": {"es": "mientras", "fuente": "caquetío-reconstruido", "notas": "Way. ama'inru'u → amainruu; confianza media", "categoria": "gramatica"},
    "amuin": {"es": "a, para", "fuente": "caquetío-reconstruido", "notas": "Way. amüin → amuin; confianza media", "categoria": "gramatica"},
    "anainje": {"es": "de, por", "fuente": "caquetío-reconstruido", "notas": "Way. anainjee → anainje; confianza media", "categoria": "gramatica"},
    "anainmuin": {"es": "a, hacia", "fuente": "caquetío-reconstruido", "notas": "Way. anainmüin → anainmuin; confianza media", "categoria": "gramatica"},
    "abulabuna": {"es": "antes de", "fuente": "caquetío-reconstruido", "notas": "Way. apülapünaa → abulabuna; confianza media", "categoria": "gramatica"},
    "abulerua": {"es": "delante de", "fuente": "caquetío-reconstruido", "notas": "Way. apüleerua → abulerua; confianza media", "categoria": "gramatica"},
    "atuma": {"es": "por", "fuente": "caquetío-reconstruido", "notas": "Way. atüma → atuma; confianza media", "categoria": "gramatica"},
    "eibaye": {"es": "en respuesta a", "fuente": "caquetío-reconstruido", "notas": "Way. e'ipajee → eibaye; confianza media", "categoria": "gramatica"},
    "einaluu": {"es": "en el fondo de, en el ekiisa", "fuente": "caquetío-reconstruido", "notas": "Way. einalu'u → einaluu; confianza media", "categoria": "gramatica"},
    "erocu": {"es": "en (un líquido)", "fuente": "caquetío-reconstruido", "notas": "Way. eroku → erocu; confianza media", "categoria": "gramatica"},
    "ouya": {"es": "vámonos", "fuente": "caquetío-reconstruido", "notas": "Way. joo'uya → ouya; confianza media", "categoria": "gramatica"},
    "catei": {"es": "¡oiga! ka'i", "fuente": "caquetío-reconstruido", "notas": "Way. kaatei → catei; confianza media", "categoria": "gramatica"},
    "outpuna": {"es": "durante", "fuente": "caquetío-reconstruido", "notas": "Way. o'utpünaa → outpuna; confianza media", "categoria": "gramatica"},
    "oyuuna": {"es": "a escondidas", "fuente": "caquetío-reconstruido", "notas": "Way. ojuuna → oyuuna; confianza media", "categoria": "gramatica"},
    "oubuna-2": {"es": "debajo de", "fuente": "caquetío-reconstruido", "notas": "Way. oupünaa → oubuna; confianza media", "categoria": "gramatica"},
    "chiale": {"es": "o ella", "fuente": "caquetío-reconstruido", "notas": "Way. shiale → chiale; confianza media", "categoria": "gramatica"},
    "baneereeya": {"es": "no hasta que", "fuente": "caquetío-reconstruido", "notas": "Way. wane'ere'eya → baneereeya; confianza media", "categoria": "gramatica"},
    "auayuuse": {"es": "esposo, -a", "fuente": "caquetío-reconstruido", "notas": "Way. a'wayuuse → auayuuse; confianza media", "categoria": "parentesco"},
    "aui": {"es": "suegro (de mujer)", "fuente": "caquetío-reconstruido", "notas": "Way. a'üi → aui; confianza media", "categoria": "parentesco"},
    "aulu": {"es": "suegra (de mujer)", "fuente": "caquetío-reconstruido", "notas": "Way. a'ülü → aulu; confianza media", "categoria": "parentesco"},
    "aunu": {"es": "enemigo, -ga", "fuente": "caquetío-reconstruido", "notas": "Way. a'ünüü → aunu; confianza media", "categoria": "parentesco"},
    "airu": {"es": "tía (materna)", "fuente": "caquetío-reconstruido", "notas": "Way. aa'irü → airu; confianza media", "categoria": "parentesco"},
    "achoniru": {"es": "sobrino, -na", "fuente": "caquetío-reconstruido", "notas": "Way. achon'irü → achoniru; confianza media", "categoria": "parentesco"},
    "alechi": {"es": "cuñado (de mujer)", "fuente": "caquetío-reconstruido", "notas": "Way. aleshi → alechi; confianza media", "categoria": "parentesco"},
    "aluin": {"es": "nieto, -ta", "fuente": "caquetío-reconstruido", "notas": "Way. alüin → aluin; confianza media", "categoria": "parentesco"},
    "aluinyuu": {"es": "cuñada (de varón)", "fuente": "caquetío-reconstruido", "notas": "Way. alüinyuu → aluinyuu; confianza media", "categoria": "parentesco"},
    "amurayuin": {"es": "novio, -via", "fuente": "caquetío-reconstruido", "notas": "Way. amüraajüin → amurayuin; confianza media", "categoria": "parentesco"},
    "abuchi": {"es": "familia, pariente", "fuente": "caquetío-reconstruido", "notas": "Way. apüshi → abuchi; confianza media", "categoria": "parentesco"},
    "achimia": {"es": "suegro (de varón)", "fuente": "caquetío-reconstruido", "notas": "Way. ashimia → achimia; confianza media", "categoria": "parentesco"},
    "achiyachi": {"es": "padrastro", "fuente": "caquetío-reconstruido", "notas": "Way. ashiyaashi → achiyachi; confianza media", "categoria": "parentesco"},
    "achunuu": {"es": "hermana menor (de varón)", "fuente": "caquetío-reconstruido", "notas": "Way. ashunuu → achunuu; confianza media", "categoria": "parentesco"},
    "atuuchi": {"es": "abuelo", "fuente": "caquetío-reconstruido", "notas": "Way. atuushi → atuuchi; confianza media", "categoria": "parentesco"},
    "atunayutu": {"es": "amigo, -ga", "fuente": "caquetío-reconstruido", "notas": "Way. atünajutü → atunayutu; confianza media", "categoria": "parentesco"},
    "eeru": {"es": "cuñada (de mujer)", "fuente": "caquetío-reconstruido", "notas": "Way. e'erü → eeru; confianza media", "categoria": "parentesco"},
    "eiruma": {"es": "primogénito, -ta", "fuente": "caquetío-reconstruido", "notas": "Way. e'iruma → eiruma; confianza media", "categoria": "parentesco"},
    "eruin": {"es": "esposa", "fuente": "caquetío-reconstruido", "notas": "Way. eerüin → eruin; confianza media", "categoria": "parentesco"},
    "eiyasu": {"es": "madrastra", "fuente": "caquetío-reconstruido", "notas": "Way. eiyaasü → eiyasu; confianza media", "categoria": "parentesco"},
    "emechi": {"es": "suegra (de varón)", "fuente": "caquetío-reconstruido", "notas": "Way. emeshi → emechi; confianza media", "categoria": "parentesco"},
    "machon": {"es": "mamá, abuela", "fuente": "caquetío-reconstruido", "notas": "Way. maachon → machon; confianza media", "categoria": "parentesco"},
    "ouliuou": {"es": "descendiente", "fuente": "caquetío-reconstruido", "notas": "Way. oo'uliwo'u → ouliuou; confianza media", "categoria": "parentesco"},
    "chale": {"es": "último hijo, última hija", "fuente": "caquetío-reconstruido", "notas": "Way. shale → chale; confianza media", "categoria": "parentesco"},
    "aaya": {"es": "quemar", "fuente": "caquetío-reconstruido", "notas": "Way. a'ajaa → aaya; confianza media", "categoria": "verbos"},
    "aaliyaua": {"es": "estar de parto", "fuente": "caquetío-reconstruido", "notas": "Way. a'alijawaa → aaliyaua; confianza media", "categoria": "verbos"},
    "aana": {"es": "armar", "fuente": "caquetío-reconstruido", "notas": "Way. a'anaa → aana; confianza media", "categoria": "verbos"},
    "aanaua": {"es": "aakkuuaaippa", "fuente": "caquetío-reconstruido", "notas": "Way. a'anawaa → aanaua; confianza media", "categoria": "verbos"},
    "aata": {"es": "a'anawaa", "fuente": "caquetío-reconstruido", "notas": "Way. a'ataa → aata; confianza media", "categoria": "verbos"},
    "aatabaya": {"es": "esperar", "fuente": "caquetío-reconstruido", "notas": "Way. a'atapajaa → aatabaya; confianza media", "categoria": "verbos"},
    "achucuta": {"es": "pisar", "fuente": "caquetío-reconstruido", "notas": "Way. a'chükütaa → achucuta; confianza media", "categoria": "verbos"},
    "aktutayaua": {"es": "sufrir un ataque", "fuente": "caquetío-reconstruido", "notas": "Way. a'ktütajawaa → aktutayaua; confianza media", "categoria": "verbos"},
    "auaya": {"es": "alabar", "fuente": "caquetío-reconstruido", "notas": "Way. a'waajaa → auaya; confianza media", "categoria": "verbos"},
    "auata": {"es": "gritar", "fuente": "caquetío-reconstruido", "notas": "Way. a'waataa → auata; confianza media", "categoria": "verbos"},
    "auataua": {"es": "jactarse", "fuente": "caquetío-reconstruido", "notas": "Way. a'waatawaa → auataua; confianza media", "categoria": "verbos"},
    "aualacaya": {"es": "dispersar, esparcir", "fuente": "caquetío-reconstruido", "notas": "Way. a'walakajaa → aualacaya; confianza media", "categoria": "verbos"},
    "auanayaua": {"es": "cambiar", "fuente": "caquetío-reconstruido", "notas": "Way. a'wanajawaa → auanayaua; confianza media", "categoria": "verbos"},
    "ayata-2": {"es": "pegar", "fuente": "caquetío-reconstruido", "notas": "Way. a'yaataa → ayata; confianza media", "categoria": "verbos"},
    "ayalaya": {"es": "llorar", "fuente": "caquetío-reconstruido", "notas": "Way. a'yalajaa → ayalaya; confianza media", "categoria": "verbos"},
    "ayabuya": {"es": "coser", "fuente": "caquetío-reconstruido", "notas": "Way. a'yapüjaa → ayabuya; confianza media", "categoria": "verbos"},
    "auluya": {"es": "regañar", "fuente": "caquetío-reconstruido", "notas": "Way. a'ülüjaa → auluya; confianza media", "categoria": "verbos"},
    "auluyiraua": {"es": "discutir", "fuente": "caquetío-reconstruido", "notas": "Way. a'ülüjirawaa → auluyiraua; confianza media", "categoria": "verbos"},
    "aurulaua": {"es": "odiar", "fuente": "caquetío-reconstruido", "notas": "Way. a'ürülawaa → aurulaua; confianza media", "categoria": "verbos"},
    "ainra": {"es": "hacer", "fuente": "caquetío-reconstruido", "notas": "Way. aa'inraa → ainra; confianza media", "categoria": "verbos"},
    "ainyaya": {"es": "colgar una hamaca", "fuente": "caquetío-reconstruido", "notas": "Way. aa'inyajaa → ainyaya; confianza media", "categoria": "verbos"},
    "acata": {"es": "quitar", "fuente": "caquetío-reconstruido", "notas": "Way. aakataa → acata; confianza media", "categoria": "verbos"},
    "amuya": {"es": "ayunar", "fuente": "caquetío-reconstruido", "notas": "Way. aamüjaa → amuya; confianza media", "categoria": "verbos"},
    "abaua": {"es": "tomar, coger", "fuente": "caquetío-reconstruido", "notas": "Way. aapawaa → abaua; confianza media", "categoria": "verbos"},
    "achichiyaua": {"es": "enojarse", "fuente": "caquetío-reconstruido", "notas": "Way. aashichijawaa → achichiyaua; confianza media", "categoria": "verbos"},
    "auala-3": {"es": "aflojar", "fuente": "caquetío-reconstruido", "notas": "Way. aawalaa → auala; confianza media", "categoria": "verbos"},
    "aualaua": {"es": "aliviarse, mejorarse (fuego)", "fuente": "caquetío-reconstruido", "notas": "Way. aawalawaa → aualaua; confianza media", "categoria": "verbos"},
    "achayaua": {"es": "buscar", "fuente": "caquetío-reconstruido", "notas": "Way. achajawaa → achayaua; confianza media", "categoria": "verbos"},
    "achechera": {"es": "apretar", "fuente": "caquetío-reconstruido", "notas": "Way. achecheraa → achechera; confianza media", "categoria": "verbos"},
    "achiyira": {"es": "despertar", "fuente": "caquetío-reconstruido", "notas": "Way. achijiraa → achiyira; confianza media", "categoria": "verbos"},
    "achiyiraua": {"es": "despertarse", "fuente": "caquetío-reconstruido", "notas": "Way. achijirawaa → achiyiraua; confianza media", "categoria": "verbos"},
    "achicu": {"es": "soltar", "fuente": "caquetío-reconstruido", "notas": "Way. achikü → achicu; confianza media", "categoria": "verbos"},
    "achita": {"es": "martillar", "fuente": "caquetío-reconstruido", "notas": "Way. achitaa → achita; confianza media", "categoria": "verbos"},
    "achula": {"es": "besar", "fuente": "caquetío-reconstruido", "notas": "Way. achu'laa → achula; confianza media", "categoria": "verbos"},
    "achumaya": {"es": "estar aiwaa", "fuente": "caquetío-reconstruido", "notas": "Way. achumajaa → achumaya; confianza media", "categoria": "verbos"},
    "achunta": {"es": "pedir", "fuente": "caquetío-reconstruido", "notas": "Way. achuntaa → achunta; confianza media", "categoria": "verbos"},
    "aikcalaua": {"es": "sentarse", "fuente": "caquetío-reconstruido", "notas": "Way. aikkalawaa → aikcalaua; confianza media", "categoria": "verbos"},
    "ayaita": {"es": "recoger agua", "fuente": "caquetío-reconstruido", "notas": "Way. aja'itaa → ayaita; confianza media", "categoria": "verbos"},
    "ayalayaua": {"es": "terminarse, agotarse", "fuente": "caquetío-reconstruido", "notas": "Way. aja'lajawaa → ayalayaua; confianza media", "categoria": "verbos"},
    "ayalayeera": {"es": "agotar", "fuente": "caquetío-reconstruido", "notas": "Way. aja'laje'eraa → ayalayeera; confianza media", "categoria": "verbos"},
    "ayatta": {"es": "terminarse, acabarse", "fuente": "caquetío-reconstruido", "notas": "Way. aja'ttaa → ayatta; confianza media", "categoria": "verbos"},
    "ayabuluuua": {"es": "estar a cargo de", "fuente": "caquetío-reconstruido", "notas": "Way. ajapulu'uwaa → ayabuluuua; confianza media", "categoria": "verbos"},
    "ayaraitta": {"es": "halar", "fuente": "caquetío-reconstruido", "notas": "Way. ajaraittaa → ayaraitta; confianza media", "categoria": "verbos"},
    "ayuitta": {"es": "salir", "fuente": "caquetío-reconstruido", "notas": "Way. ajuittaa → ayuitta; confianza media", "categoria": "verbos"},
    "ayuittira": {"es": "sacar", "fuente": "caquetío-reconstruido", "notas": "Way. ajuittiraa → ayuittira; confianza media", "categoria": "verbos"},
    "ayuyaua": {"es": "bostezar", "fuente": "caquetío-reconstruido", "notas": "Way. ajujawaa → ayuyaua; confianza media", "categoria": "verbos"},
    "ayurulaya": {"es": "revolver", "fuente": "caquetío-reconstruido", "notas": "Way. ajurulajaa → ayurulaya; confianza media", "categoria": "verbos"},
    "ayuta": {"es": "tirar, lanzar", "fuente": "caquetío-reconstruido", "notas": "Way. ajutaa → ayuta; confianza media", "categoria": "verbos"},
    "ayutuua": {"es": "caerse", "fuente": "caquetío-reconstruido", "notas": "Way. ajutuwaa → ayutuua; confianza media", "categoria": "verbos"},
    "acachera": {"es": "colgar", "fuente": "caquetío-reconstruido", "notas": "Way. akacheraa → acachera; confianza media", "categoria": "verbos"},
    "acaiya": {"es": "fumar", "fuente": "caquetío-reconstruido", "notas": "Way. akaijaa → acaiya; confianza media", "categoria": "verbos"},
    "acaluuya": {"es": "llenar", "fuente": "caquetío-reconstruido", "notas": "Way. akalu'ujaa → acaluuya; confianza media", "categoria": "verbos"},
    "acanaya": {"es": "ganar", "fuente": "caquetío-reconstruido", "notas": "Way. akanajaa → acanaya; confianza media", "categoria": "verbos"},
    "acatala": {"es": "separar, apartar", "fuente": "caquetío-reconstruido", "notas": "Way. akatalaa → acatala; confianza media", "categoria": "verbos"},
    "acatalaua": {"es": "apartarse", "fuente": "caquetío-reconstruido", "notas": "Way. akatalawaa → acatalaua; confianza media", "categoria": "verbos"},
    "acotchaya": {"es": "ajurulajaa", "fuente": "caquetío-reconstruido", "notas": "Way. akotchajaa → acotchaya; confianza media", "categoria": "verbos"},
    "acurula": {"es": "tener frío", "fuente": "caquetío-reconstruido", "notas": "Way. akurulaa → acurula; confianza media", "categoria": "verbos"},
    "acutcuyaua": {"es": "temblar", "fuente": "caquetío-reconstruido", "notas": "Way. akutkujawaa → acutcuyaua; confianza media", "categoria": "verbos"},
    "acunula": {"es": "masticar", "fuente": "caquetío-reconstruido", "notas": "Way. akünülaa → acunula; confianza media", "categoria": "verbos"},
    "alabaya": {"es": "lamentar la muerte de", "fuente": "caquetío-reconstruido", "notas": "Way. alapajaa → alabaya; confianza media", "categoria": "verbos"},
    "aleua": {"es": "tener amistad", "fuente": "caquetío-reconstruido", "notas": "Way. aleewaa → aleua; confianza media", "categoria": "verbos"},
    "aleraya": {"es": "sentir asco por", "fuente": "caquetío-reconstruido", "notas": "Way. alerajaa → aleraya; confianza media", "categoria": "verbos"},
    "aliichaya": {"es": "ordeñar", "fuente": "caquetío-reconstruido", "notas": "Way. aliichajaa → aliichaya; confianza media", "categoria": "verbos"},
    "aliicayaua": {"es": "subir, subirse", "fuente": "caquetío-reconstruido", "notas": "Way. aliikajawaa → aliicayaua; confianza media", "categoria": "verbos"},
    "aluuya": {"es": "llevar, cargar, traer", "fuente": "caquetío-reconstruido", "notas": "Way. alü'üjaa → aluuya; confianza media", "categoria": "verbos"},
    "aluya": {"es": "rastrear", "fuente": "caquetío-reconstruido", "notas": "Way. alüjaa → aluya; confianza media", "categoria": "verbos"},
    "amausiya": {"es": "domar, amansar", "fuente": "caquetío-reconstruido", "notas": "Way. amaüsijaa → amausiya; confianza media", "categoria": "verbos"},
    "amoyuya": {"es": "dañar, perjudicar", "fuente": "caquetío-reconstruido", "notas": "Way. amojujaa → amoyuya; confianza media", "categoria": "verbos"},
    "amuliaya": {"es": "compadecerse de", "fuente": "caquetío-reconstruido", "notas": "Way. amüliajaa → amuliaya; confianza media", "categoria": "verbos"},
    "amuloulii": {"es": "perderse", "fuente": "caquetío-reconstruido", "notas": "Way. amüloulii → amuloulii; confianza media", "categoria": "verbos"},
    "amuscheya": {"es": "atragantarse", "fuente": "caquetío-reconstruido", "notas": "Way. amüschejaa → amuscheya; confianza media", "categoria": "verbos"},
    "anachonba": {"es": "ser bonito, -ta", "fuente": "caquetío-reconstruido", "notas": "Way. anachonwaa → anachonba; confianza media", "categoria": "verbos"},
    "anaya": {"es": "mirar, observar", "fuente": "caquetío-reconstruido", "notas": "Way. anajaa → anaya; confianza media", "categoria": "verbos"},
    "anaca": {"es": "alumbrar", "fuente": "caquetío-reconstruido", "notas": "Way. anakaa → anaca; confianza media", "categoria": "verbos"},
    "analaua": {"es": "averiguar qué es", "fuente": "caquetío-reconstruido", "notas": "Way. analawaa → analaua; confianza media", "categoria": "verbos"},
    "analu": {"es": "estar mejor de salud", "fuente": "caquetío-reconstruido", "notas": "Way. analüü → analu; confianza media", "categoria": "verbos"},
    "aneca": {"es": "escoger", "fuente": "caquetío-reconstruido", "notas": "Way. aneekaa → aneca; confianza media", "categoria": "verbos"},
    "anoukta": {"es": "corregir, arreglar", "fuente": "caquetío-reconstruido", "notas": "Way. anouktaa → anoukta; confianza media", "categoria": "verbos"},
    "antira": {"es": "traer", "fuente": "caquetío-reconstruido", "notas": "Way. antiraa → antira; confianza media", "categoria": "verbos"},
    "abalalaya": {"es": "ir de compras", "fuente": "caquetío-reconstruido", "notas": "Way. apalaalajaa → abalalaya; confianza media", "categoria": "verbos"},
    "abalanayaua": {"es": "fluir", "fuente": "caquetío-reconstruido", "notas": "Way. apalanajawaa → abalanayaua; confianza media", "categoria": "verbos"},
    "abaliraya": {"es": "mezclar", "fuente": "caquetío-reconstruido", "notas": "Way. apalirajaa → abaliraya; confianza media", "categoria": "verbos"},
    "abanabaya": {"es": "encontrarse con una", "fuente": "caquetío-reconstruido", "notas": "Way. apanapajaa → abanabaya; confianza media", "categoria": "verbos"},
    "abantayaua": {"es": "irse corriendo", "fuente": "caquetío-reconstruido", "notas": "Way. apantajawaa → abantayaua; confianza media", "categoria": "verbos"},
    "abasiayaua": {"es": "hacer una visita", "fuente": "caquetío-reconstruido", "notas": "Way. apasiajawaa → abasiayaua; confianza media", "categoria": "verbos"},
    "abula": {"es": "ser", "fuente": "caquetío-reconstruido", "notas": "Way. apüla → abula; confianza media", "categoria": "verbos"},
    "abulaya": {"es": "prohibir", "fuente": "caquetío-reconstruido", "notas": "Way. apülajaa → abulaya; confianza media", "categoria": "verbos"},
    "abunaya": {"es": "sembrar", "fuente": "caquetío-reconstruido", "notas": "Way. apünajaa → abunaya; confianza media", "categoria": "verbos"},
    "abuta": {"es": "dejar", "fuente": "caquetío-reconstruido", "notas": "Way. apütaa → abuta; confianza media", "categoria": "verbos"},
    "aralaya": {"es": "dejar en remojo", "fuente": "caquetío-reconstruido", "notas": "Way. aralajaa → aralaya; confianza media", "categoria": "verbos"},
    "asalaya": {"es": "afilar", "fuente": "caquetío-reconstruido", "notas": "Way. asalajaa → asalaya; confianza media", "categoria": "verbos"},
    "achaualaua": {"es": "ponerse de pie", "fuente": "caquetío-reconstruido", "notas": "Way. asha'walawaa → achaualaua; confianza media", "categoria": "verbos"},
    "achaitta": {"es": "jugar", "fuente": "caquetío-reconstruido", "notas": "Way. ashaittaa → achaitta; confianza media", "categoria": "verbos"},
    "achabataua": {"es": "preocuparse", "fuente": "caquetío-reconstruido", "notas": "Way. ashapatawaa → achabataua; confianza media", "categoria": "verbos"},
    "achata": {"es": "sanar (una herida)", "fuente": "caquetío-reconstruido", "notas": "Way. ashataa → achata; confianza media", "categoria": "verbos"},
    "acheeyiraua": {"es": "pelear con puños", "fuente": "caquetío-reconstruido", "notas": "Way. ashe'ejirawaa → acheeyiraua; confianza media", "categoria": "verbos"},
    "acheeta": {"es": "golpear, patear", "fuente": "caquetío-reconstruido", "notas": "Way. ashe'etaa → acheeta; confianza media", "categoria": "verbos"},
    "achiita": {"es": "orinar", "fuente": "caquetío-reconstruido", "notas": "Way. ashiitaa → achiita; confianza media", "categoria": "verbos"},
    "achiyaua": {"es": "lavar (ropa)", "fuente": "caquetío-reconstruido", "notas": "Way. ashijawaa → achiyaua; confianza media", "categoria": "verbos"},
    "achuta": {"es": "meterse, entrar a la", "fuente": "caquetío-reconstruido", "notas": "Way. ashutaa → achuta; confianza media", "categoria": "verbos"},
    "asiiyayaua": {"es": "ensillar", "fuente": "caquetío-reconstruido", "notas": "Way. asiiyajawaa → asiiyayaua; confianza media", "categoria": "verbos"},
    "asiya": {"es": "asar", "fuente": "caquetío-reconstruido", "notas": "Way. asijaa → asiya; confianza media", "categoria": "verbos"},
    "asiraya": {"es": "reirse", "fuente": "caquetío-reconstruido", "notas": "Way. asirajaa → asiraya; confianza media", "categoria": "verbos"},
    "asiranayaua": {"es": "resbalarse", "fuente": "caquetío-reconstruido", "notas": "Way. asiranajawaa → asiranayaua; confianza media", "categoria": "verbos"},
    "asiuata": {"es": "desatar", "fuente": "caquetío-reconstruido", "notas": "Way. asiwataa → asiuata; confianza media", "categoria": "verbos"},
    "asoukta": {"es": "responder", "fuente": "caquetío-reconstruido", "notas": "Way. asouktaa → asoukta; confianza media", "categoria": "verbos"},
    "asuca": {"es": "recoger leña", "fuente": "caquetío-reconstruido", "notas": "Way. asukaa → asuca; confianza media", "categoria": "verbos"},
    "asuuta": {"es": "arrancar", "fuente": "caquetío-reconstruido", "notas": "Way. asü'ütaa → asuuta; confianza media", "categoria": "verbos"},
    "asucuita": {"es": "rasgarse", "fuente": "caquetío-reconstruido", "notas": "Way. asüküitaa → asucuita; confianza media", "categoria": "verbos"},
    "atamaua": {"es": "levantarse", "fuente": "caquetío-reconstruido", "notas": "Way. atamawaa → atamaua; confianza media", "categoria": "verbos"},
    "atauyaua": {"es": "violar (a una mujer)", "fuente": "caquetío-reconstruido", "notas": "Way. ataüjawaa → atauyaua; confianza media", "categoria": "verbos"},
    "atcaua": {"es": "pelear", "fuente": "caquetío-reconstruido", "notas": "Way. atkawaa → atcaua; confianza media", "categoria": "verbos"},
    "atpaya": {"es": "recolectar (alimento)", "fuente": "caquetío-reconstruido", "notas": "Way. atpajaa → atpaya; confianza media", "categoria": "verbos"},
    "atuya": {"es": "saber", "fuente": "caquetío-reconstruido", "notas": "Way. atüjaa → atuya; confianza media", "categoria": "verbos"},
    "atucaua": {"es": "atascarse", "fuente": "caquetío-reconstruido", "notas": "Way. atükawaa → atucaua; confianza media", "categoria": "verbos"},
    "atutuya": {"es": "animar, ayolojo", "fuente": "caquetío-reconstruido", "notas": "Way. atütüjaa → atutuya; confianza media", "categoria": "verbos"},
    "auayaua": {"es": "rajarse, partirse", "fuente": "caquetío-reconstruido", "notas": "Way. awajawaa → auayaua; confianza media", "categoria": "verbos"},
    "auareya": {"es": "barrer", "fuente": "caquetío-reconstruido", "notas": "Way. awareejaa → auareya; confianza media", "categoria": "verbos"},
    "auataua-2": {"es": "correr", "fuente": "caquetío-reconstruido", "notas": "Way. awatawaa → auataua; confianza media", "categoria": "verbos"},
    "ayauata": {"es": "reconocer", "fuente": "caquetío-reconstruido", "notas": "Way. ayaawataa → ayauata; confianza media", "categoria": "verbos"},
    "ayalera": {"es": "levantar, alzar", "fuente": "caquetío-reconstruido", "notas": "Way. ayaleraa → ayalera; confianza media", "categoria": "verbos"},
    "ayouyiraua": {"es": "competir", "fuente": "caquetío-reconstruido", "notas": "Way. ayoujirawaa → ayouyiraua; confianza media", "categoria": "verbos"},
    "ayounja": {"es": "azotar", "fuente": "caquetío-reconstruido", "notas": "Way. ayounjaa → ayounja; confianza media", "categoria": "verbos"},
    "ayuyaua-2": {"es": "moler", "fuente": "caquetío-reconstruido", "notas": "Way. ayüüjawaa → ayuyaua; confianza media", "categoria": "verbos"},
    "auya": {"es": "cortar (el pelo), afeitar", "fuente": "caquetío-reconstruido", "notas": "Way. aüjaa → auya; confianza media", "categoria": "verbos"},
    "auyaua": {"es": "matar (ganado)", "fuente": "caquetío-reconstruido", "notas": "Way. aüjawaa → auyaua; confianza media", "categoria": "verbos"},
    "aurula": {"es": "estar flaco, -ca", "fuente": "caquetío-reconstruido", "notas": "Way. aürülaa → aurula; confianza media", "categoria": "verbos"},
    "eiiya": {"es": "tener diarrea", "fuente": "caquetío-reconstruido", "notas": "Way. e'iijaa → eiiya; confianza media", "categoria": "verbos"},
    "eiita": {"es": "defecar", "fuente": "caquetío-reconstruido", "notas": "Way. e'iitaa → eiita; confianza media", "categoria": "verbos"},
    "eica": {"es": "enseñar, instruir", "fuente": "caquetío-reconstruido", "notas": "Way. e'ikaa → eica; confianza media", "categoria": "verbos"},
    "eicayaua": {"es": "llevar y dejar", "fuente": "caquetío-reconstruido", "notas": "Way. e'ikajawaa → eicayaua; confianza media", "categoria": "verbos"},
    "eicaua": {"es": "estar herido, -da", "fuente": "caquetío-reconstruido", "notas": "Way. e'ikawaa → eicaua; confianza media", "categoria": "verbos"},
    "eina": {"es": "tejer con aguja", "fuente": "caquetío-reconstruido", "notas": "Way. e'inaa → eina; confianza media", "categoria": "verbos"},
    "eibunaua": {"es": "llevar y dejar de", "fuente": "caquetío-reconstruido", "notas": "Way. e'ipünawaa → eibunaua; confianza media", "categoria": "verbos"},
    "eita": {"es": "aportar", "fuente": "caquetío-reconstruido", "notas": "Way. e'itaa → eita; confianza media", "categoria": "verbos"},
    "eitaua": {"es": "poner, meter", "fuente": "caquetío-reconstruido", "notas": "Way. e'itawaa → eitaua; confianza media", "categoria": "verbos"},
    "eraya": {"es": "conocer", "fuente": "caquetío-reconstruido", "notas": "Way. e'raajaa → eraya; confianza media", "categoria": "verbos"},
    "eraya-2": {"es": "mirar", "fuente": "caquetío-reconstruido", "notas": "Way. e'rajaa → eraya; confianza media", "categoria": "verbos"},
    "eirataua": {"es": "cambiar de esposo, -sa", "fuente": "caquetío-reconstruido", "notas": "Way. ee'iratawaa → eirataua; confianza media", "categoria": "verbos"},
    "eua": {"es": "haber, existir", "fuente": "caquetío-reconstruido", "notas": "Way. eewaa → eua; confianza media", "categoria": "verbos"},
    "euaua": {"es": "accidentarse", "fuente": "caquetío-reconstruido", "notas": "Way. eewawaa → euaua; confianza media", "categoria": "verbos"},
    "eimalaua": {"es": "ekiipala n", "fuente": "caquetío-reconstruido", "notas": "Way. eimalawaa → eimalaua; confianza media", "categoria": "verbos"},
    "eibira": {"es": "perseguir", "fuente": "caquetío-reconstruido", "notas": "Way. eipiraa → eibira; confianza media", "categoria": "verbos"},
    "eisalaua": {"es": "acostarse", "fuente": "caquetío-reconstruido", "notas": "Way. eisalawaa → eisalaua; confianza media", "categoria": "verbos"},
    "eitaya": {"es": "repartir", "fuente": "caquetío-reconstruido", "notas": "Way. eitajaa → eitaya; confianza media", "categoria": "verbos"},
    "eiteera": {"es": "devolver", "fuente": "caquetío-reconstruido", "notas": "Way. eite'eraa → eiteera; confianza media", "categoria": "verbos"},
    "eiyaya": {"es": "curar", "fuente": "caquetío-reconstruido", "notas": "Way. eiyajaa → eiyaya; confianza media", "categoria": "verbos"},
    "eyeyeraua": {"es": "cuchichear, secretear", "fuente": "caquetío-reconstruido", "notas": "Way. ejejerawaa → eyeyeraua; confianza media", "categoria": "verbos"},
    "eyemplo": {"es": "estar cerrado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. ejemplo → eyemplo; confianza media", "categoria": "verbos"},
    "eyeta": {"es": "escupir", "fuente": "caquetío-reconstruido", "notas": "Way. ejetaa → eyeta; confianza media", "categoria": "verbos"},
    "eyita": {"es": "verter (polvos o granos)", "fuente": "caquetío-reconstruido", "notas": "Way. ejitaa → eyita; confianza media", "categoria": "verbos"},
    "eyittaua": {"es": "atar", "fuente": "caquetío-reconstruido", "notas": "Way. ejittawaa → eyittaua; confianza media", "categoria": "verbos"},
    "eceroyira": {"es": "meter", "fuente": "caquetío-reconstruido", "notas": "Way. ekerojiraa → eceroyira; confianza media", "categoria": "verbos"},
    "ecii": {"es": "dolerle la cabeza", "fuente": "caquetío-reconstruido", "notas": "Way. ekii → ecii; confianza media", "categoria": "verbos"},
    "eciraya": {"es": "enseñar", "fuente": "caquetío-reconstruido", "notas": "Way. ekirajaa → eciraya; confianza media", "categoria": "verbos"},
    "emeerayaua": {"es": "bromear", "fuente": "caquetío-reconstruido", "notas": "Way. eme'erajawaa → emeerayaua; confianza media", "categoria": "verbos"},
    "ebeyaua": {"es": "prender, encender", "fuente": "caquetío-reconstruido", "notas": "Way. epejawaa → ebeyaua; confianza media", "categoria": "verbos"},
    "ebetta": {"es": "tocar", "fuente": "caquetío-reconstruido", "notas": "Way. epettaa → ebetta; confianza media", "categoria": "verbos"},
    "ebiraya": {"es": "llenar, inflar", "fuente": "caquetío-reconstruido", "notas": "Way. epirajaa → ebiraya; confianza media", "categoria": "verbos"},
    "eueta": {"es": "salir a la vista, aparecer", "fuente": "caquetío-reconstruido", "notas": "Way. eweetaa → eueta; confianza media", "categoria": "verbos"},
    "euiiya": {"es": "silbar", "fuente": "caquetío-reconstruido", "notas": "Way. ewiijaa → euiiya; confianza media", "categoria": "verbos"},
    "iche": {"es": "estar tenso, -sa", "fuente": "caquetío-reconstruido", "notas": "Way. ichee → iche; confianza media", "categoria": "verbos"},
    "icha": {"es": "sufrir una quemadura", "fuente": "caquetío-reconstruido", "notas": "Way. ishaa → icha; confianza media", "categoria": "verbos"},
    "ita": {"es": "secarse", "fuente": "caquetío-reconstruido", "notas": "Way. itaa → ita; confianza media", "categoria": "verbos"},
    "iua": {"es": "ser prostituta", "fuente": "caquetío-reconstruido", "notas": "Way. iwaa → iua; confianza media", "categoria": "verbos"},
    "aiyaua": {"es": "faltar", "fuente": "caquetío-reconstruido", "notas": "Way. ja'ijawaa → aiyaua; confianza media", "categoria": "verbos"},
    "aiua": {"es": "estar caliente", "fuente": "caquetío-reconstruido", "notas": "Way. ja'iwaa → aiua; confianza media", "categoria": "verbos"},
    "aya-2": {"es": "aparecer", "fuente": "caquetío-reconstruido", "notas": "Way. ja'yaa → aya; confianza media", "categoria": "verbos"},
    "ayumuu": {"es": "estar bien", "fuente": "caquetío-reconstruido", "notas": "Way. ja'yumuu → ayumuu; confianza media", "categoria": "verbos"},
    "ala": {"es": "dónde estar", "fuente": "caquetío-reconstruido", "notas": "Way. jalaa → ala; confianza media", "categoria": "verbos"},
    "amama": {"es": "ser liviano, -na", "fuente": "caquetío-reconstruido", "notas": "Way. jamaamaa → amama; confianza media", "categoria": "verbos"},
    "abulii": {"es": "tener vergüenza", "fuente": "caquetío-reconstruido", "notas": "Way. japülii → abulii; confianza media", "categoria": "verbos"},
    "achuuua": {"es": "ser agrio, -a", "fuente": "caquetío-reconstruido", "notas": "Way. jashü'üwaa → achuuua; confianza media", "categoria": "verbos"},
    "auaaua": {"es": "estar flojo, -ja", "fuente": "caquetío-reconstruido", "notas": "Way. jawa'awaa → auaaua; confianza media", "categoria": "verbos"},
    "auata-2": {"es": "ser pesado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. jawataa → auata; confianza media", "categoria": "verbos"},
    "aya-3": {"es": "ser barato, -ta", "fuente": "caquetío-reconstruido", "notas": "Way. jayaa → aya; confianza media", "categoria": "verbos"},
    "yeue": {"es": "estar maduro, -ra", "fuente": "caquetío-reconstruido", "notas": "Way. je'wee → yeue; confianza media", "categoria": "verbos"},
    "yemeta": {"es": "ser sabroso, -sa", "fuente": "caquetío-reconstruido", "notas": "Way. jemetaa → yemeta; confianza media", "categoria": "verbos"},
    "yera": {"es": "cuánto ser", "fuente": "caquetío-reconstruido", "notas": "Way. jera → yera; confianza media", "categoria": "verbos"},
    "yerula": {"es": "ser ancho, -cha", "fuente": "caquetío-reconstruido", "notas": "Way. jerulaa → yerula; confianza media", "categoria": "verbos"},
    "oloto": {"es": "tener ampolla", "fuente": "caquetío-reconstruido", "notas": "Way. jolotoo → oloto; confianza media", "categoria": "verbos"},
    "oso": {"es": "estar seco, -ca", "fuente": "caquetío-reconstruido", "notas": "Way. josoo → oso; confianza media", "categoria": "verbos"},
    "ota": {"es": "arder", "fuente": "caquetío-reconstruido", "notas": "Way. jotaa → ota; confianza media", "categoria": "verbos"},
    "oyoto": {"es": "estar sentado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. joyotoo → oyoto; confianza media", "categoria": "verbos"},
    "utata": {"es": "estar abierto, -ta", "fuente": "caquetío-reconstruido", "notas": "Way. jutataa → utata; confianza media", "categoria": "verbos"},
    "cauayuuse": {"es": "tener esposo, -sa", "fuente": "caquetío-reconstruido", "notas": "Way. ka'wayuusee → cauayuuse; confianza media", "categoria": "verbos"},
    "cayata": {"es": "estar un poco retirado", "fuente": "caquetío-reconstruido", "notas": "Way. ka'yataa → cayata; confianza media", "categoria": "verbos"},
    "cainjala": {"es": "causar daño, pecar", "fuente": "caquetío-reconstruido", "notas": "Way. kaainjalaa → cainjala; confianza media", "categoria": "verbos"},
    "cacheta": {"es": "estar colgado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. kachetaa → cacheta; confianza media", "categoria": "verbos"},
    "cacua": {"es": "ser veloz (andando)", "fuente": "caquetío-reconstruido", "notas": "Way. kakuaa → cacua; confianza media", "categoria": "verbos"},
    "caluuua": {"es": "contener", "fuente": "caquetío-reconstruido", "notas": "Way. kalu'uwaa → caluuua; confianza media", "categoria": "verbos"},
    "canulia": {"es": "ser llamado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. kanüliaa → canulia; confianza media", "categoria": "verbos"},
    "cabu": {"es": "estar atado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. kapüü → cabu; confianza media", "categoria": "verbos"},
    "casa": {"es": "tener filo", "fuente": "caquetío-reconstruido", "notas": "Way. kasaa → casa; confianza media", "categoria": "verbos"},
    "catchinba": {"es": "ser fuerte", "fuente": "caquetío-reconstruido", "notas": "Way. katchinwaa → catchinba; confianza media", "categoria": "verbos"},
    "cena": {"es": "derramarse", "fuente": "caquetío-reconstruido", "notas": "Way. keenaa → cena; confianza media", "categoria": "verbos"},
    "cisaua": {"es": "estar guisado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. kisaawaa → cisaua; confianza media", "categoria": "verbos"},
    "cooyoua": {"es": "ser redondo, -da", "fuente": "caquetío-reconstruido", "notas": "Way. ko'oyowaa → cooyoua; confianza media", "categoria": "verbos"},
    "couta": {"es": "estar callado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. ko'utaa → couta; confianza media", "categoria": "verbos"},
    "coyuta": {"es": "ser caro, -ra", "fuente": "caquetío-reconstruido", "notas": "Way. kojutaa → coyuta; confianza media", "categoria": "verbos"},
    "coya": {"es": "pincharse", "fuente": "caquetío-reconstruido", "notas": "Way. koojaa → coya; confianza media", "categoria": "verbos"},
    "laualaua": {"es": "ser flexible", "fuente": "caquetío-reconstruido", "notas": "Way. la'walawaa → laualaua; confianza media", "categoria": "verbos"},
    "lemta": {"es": "arrastrarse", "fuente": "caquetío-reconstruido", "notas": "Way. lemtaa → lemta; confianza media", "categoria": "verbos"},
    "lota": {"es": "ser recto, -ta", "fuente": "caquetío-reconstruido", "notas": "Way. lotaa → lota; confianza media", "categoria": "verbos"},
    "mainba": {"es": "ser necio, -cia", "fuente": "caquetío-reconstruido", "notas": "Way. maa'inwaa → mainba; confianza media", "categoria": "verbos"},
    "macheeua": {"es": "ser sordo, -da", "fuente": "caquetío-reconstruido", "notas": "Way. mache'ewaa → macheeua; confianza media", "categoria": "verbos"},
    "maitta": {"es": "estar en calma el tiempo", "fuente": "caquetío-reconstruido", "notas": "Way. maittaa → maitta; confianza media", "categoria": "verbos"},
    "mamainna": {"es": "ser loco, -ca", "fuente": "caquetío-reconstruido", "notas": "Way. mamainnaa → mamainna; confianza media", "categoria": "verbos"},
    "mabuleua": {"es": "ser fácil", "fuente": "caquetío-reconstruido", "notas": "Way. mapülewaa → mabuleua; confianza media", "categoria": "verbos"},
    "maralu": {"es": "ser estéril", "fuente": "caquetío-reconstruido", "notas": "Way. maralüü → maralu; confianza media", "categoria": "verbos"},
    "mariiya": {"es": "ser amarillo, -lla", "fuente": "caquetío-reconstruido", "notas": "Way. mariiyaa → mariiya; confianza media", "categoria": "verbos"},
    "matsuinba": {"es": "estar sin fuerza", "fuente": "caquetío-reconstruido", "notas": "Way. matsüinwaa → matsuinba; confianza media", "categoria": "verbos"},
    "miyasu": {"es": "tener sed", "fuente": "caquetío-reconstruido", "notas": "Way. miyaasüü → miyasu; confianza media", "categoria": "verbos"},
    "moluu": {"es": "tener 2", "fuente": "caquetío-reconstruido", "notas": "Way. mmoluu → moluu; confianza media", "categoria": "verbos"},
    "mouu": {"es": "ser ciego, -ga", "fuente": "caquetío-reconstruido", "notas": "Way. mo'uu → mouu; confianza media", "categoria": "verbos"},
    "mutsiiya": {"es": "ser negro, -gra", "fuente": "caquetío-reconstruido", "notas": "Way. mütsiiyaa → mutsiiya; confianza media", "categoria": "verbos"},
    "ootoyoua": {"es": "sacudir", "fuente": "caquetío-reconstruido", "notas": "Way. o'otojowaa → ootoyoua; confianza media", "categoria": "verbos"},
    "ootoua": {"es": "montar", "fuente": "caquetío-reconstruido", "notas": "Way. o'otowaa → ootoua; confianza media", "categoria": "verbos"},
    "otta": {"es": "aterrizar", "fuente": "caquetío-reconstruido", "notas": "Way. o'ttaa → otta; confianza media", "categoria": "verbos"},
    "otteera": {"es": "hacer pasar", "fuente": "caquetío-reconstruido", "notas": "Way. o'tte'eraa → otteera; confianza media", "categoria": "verbos"},
    "ouliya": {"es": "cargar (a un niño)", "fuente": "caquetío-reconstruido", "notas": "Way. o'ulijaa → ouliya; confianza media", "categoria": "verbos"},
    "ounira": {"es": "llevar", "fuente": "caquetío-reconstruido", "notas": "Way. o'uniraa → ounira; confianza media", "categoria": "verbos"},
    "oyoto-2": {"es": "verter (un líquido)", "fuente": "caquetío-reconstruido", "notas": "Way. o'yotoo → oyoto; confianza media", "categoria": "verbos"},
    "oyotoua": {"es": "cortar (con cuchillo, abdomen)", "fuente": "caquetío-reconstruido", "notas": "Way. o'yotowaa → oyotoua; confianza media", "categoria": "verbos"},
    "oyoita": {"es": "enterrar", "fuente": "caquetío-reconstruido", "notas": "Way. ojoitaa → oyoita; confianza media", "categoria": "verbos"},
    "oyotta": {"es": "morder", "fuente": "caquetío-reconstruido", "notas": "Way. ojottaa → oyotta; confianza media", "categoria": "verbos"},
    "oyununtaua": {"es": "o'ktaa", "fuente": "caquetío-reconstruido", "notas": "Way. ojununtawaa → oyununtaua; confianza media", "categoria": "verbos"},
    "oyutta": {"es": "caer", "fuente": "caquetío-reconstruido", "notas": "Way. ojuttaa → oyutta; confianza media", "categoria": "verbos"},
    "oyuttira": {"es": "derribar, 2", "fuente": "caquetío-reconstruido", "notas": "Way. ojuttiraa → oyuttira; confianza media", "categoria": "verbos"},
    "ocoolo": {"es": "envolver", "fuente": "caquetío-reconstruido", "notas": "Way. oko'oloo → ocoolo; confianza media", "categoria": "verbos"},
    "ocoloyo": {"es": "llevar regalo", "fuente": "caquetío-reconstruido", "notas": "Way. okolojoo → ocoloyo; confianza media", "categoria": "verbos"},
    "oui": {"es": "tropezar", "fuente": "caquetío-reconstruido", "notas": "Way. oo'ui → oui; confianza media", "categoria": "verbos"},
    "oyo": {"es": "raspar", "fuente": "caquetío-reconstruido", "notas": "Way. oojoo → oyo; confianza media", "categoria": "verbos"},
    "onoyo": {"es": "toser", "fuente": "caquetío-reconstruido", "notas": "Way. oonojoo → onoyo; confianza media", "categoria": "verbos"},
    "otoyo": {"es": "perforar", "fuente": "caquetío-reconstruido", "notas": "Way. ootojoo → otoyo; confianza media", "categoria": "verbos"},
    "oboloyo": {"es": "hervir", "fuente": "caquetío-reconstruido", "notas": "Way. opoolojoo → oboloyo; confianza media", "categoria": "verbos"},
    "ochoyo": {"es": "desollar, pelar, curandero, -ra", "fuente": "caquetío-reconstruido", "notas": "Way. oshojoo → ochoyo; confianza media", "categoria": "verbos"},
    "ounjula": {"es": "esconder", "fuente": "caquetío-reconstruido", "notas": "Way. ounjulaa → ounjula; confianza media", "categoria": "verbos"},
    "ounjulaua": {"es": "esconderse", "fuente": "caquetío-reconstruido", "notas": "Way. ounjulawaa → ounjulaua; confianza media", "categoria": "verbos"},
    "ourula": {"es": "estar hinchado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. ourulaa → ourula; confianza media", "categoria": "verbos"},
    "ouchuua": {"es": "tener fiebre", "fuente": "caquetío-reconstruido", "notas": "Way. oushuwaa → ouchuua; confianza media", "categoria": "verbos"},
    "ouyanta": {"es": "volver", "fuente": "caquetío-reconstruido", "notas": "Way. ouyantaa → ouyanta; confianza media", "categoria": "verbos"},
    "painba": {"es": "estar de acuerdo", "fuente": "caquetío-reconstruido", "notas": "Way. paa'inwaa → painba; confianza media", "categoria": "verbos"},
    "palaua": {"es": "ser salado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. palawaa → palaua; confianza media", "categoria": "verbos"},
    "paliraua": {"es": "estar mezclado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. palirawaa → paliraua; confianza media", "categoria": "verbos"},
    "pansaua": {"es": "estar derecho, -cha", "fuente": "caquetío-reconstruido", "notas": "Way. pansawaa → pansaua; confianza media", "categoria": "verbos"},
    "peye": {"es": "estar cerca", "fuente": "caquetío-reconstruido", "notas": "Way. pejee → peye; confianza media", "categoria": "verbos"},
    "pera": {"es": "ser mocho, -cha", "fuente": "caquetío-reconstruido", "notas": "Way. peraa → pera; confianza media", "categoria": "verbos"},
    "pula": {"es": "ser poderoso, -sa", "fuente": "caquetío-reconstruido", "notas": "Way. pülaa → pula; confianza media", "categoria": "verbos"},
    "puresa": {"es": "estar preso, -sa", "fuente": "caquetío-reconstruido", "notas": "Way. püreesaa → puresa; confianza media", "categoria": "verbos"},
    "chocota": {"es": "ser curvo, -va", "fuente": "caquetío-reconstruido", "notas": "Way. shokotaa → chocota; confianza media", "categoria": "verbos"},
    "chotta": {"es": "gotear", "fuente": "caquetío-reconstruido", "notas": "Way. shottaa → chotta; confianza media", "categoria": "verbos"},
    "sirasira": {"es": "ser liso, -sa", "fuente": "caquetío-reconstruido", "notas": "Way. sirasiraa → sirasira; confianza media", "categoria": "verbos"},
    "bauata": {"es": "soplar (el viento)", "fuente": "caquetío-reconstruido", "notas": "Way. waawataa → bauata; confianza media", "categoria": "verbos"},
    "balaua": {"es": "estar pagado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. walawaa → balaua; confianza media", "categoria": "verbos"},
    "banaua": {"es": "ser lo mismo, ser", "fuente": "caquetío-reconstruido", "notas": "Way. wanaawaa → banaua; confianza media", "categoria": "verbos"},
    "buinsira": {"es": "ahogarse (en agua)", "fuente": "caquetío-reconstruido", "notas": "Way. wüinsiraa → buinsira; confianza media", "categoria": "verbos"},
    "buitta": {"es": "ser azul, ser verde", "fuente": "caquetío-reconstruido", "notas": "Way. wüittaa → buitta; confianza media", "categoria": "verbos"},
    "yalayala": {"es": "ser áspero, -ra", "fuente": "caquetío-reconstruido", "notas": "Way. yalayalaa → yalayala; confianza media", "categoria": "verbos"},
    "yarutta": {"es": "estar sucio", "fuente": "caquetío-reconstruido", "notas": "Way. yarüttaa → yarutta; confianza media", "categoria": "verbos"},
    "yocuta": {"es": "estar apagado, -da", "fuente": "caquetío-reconstruido", "notas": "Way. yokutaa → yocuta; confianza media", "categoria": "verbos"},
