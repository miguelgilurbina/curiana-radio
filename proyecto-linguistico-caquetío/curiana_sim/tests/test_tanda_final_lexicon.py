...
def test_c_4a_iro_y_uco_se_ensenan_con_su_rotulo_y_siguen_en_el_desafijador():
    # `-kuba` y `-ba` entran con D11 fase 3 en la misma tanda (tf.2); lo que
    # este test vigila es que -iro/-uco NO salgan del desafijador.
    sufijos_antes = {"-aima", "-ana", "-ba", "-bakoa", "-bana", "-da", "-ima", "-iro",
                     "-ka", "-kana", "-kuba", "-ni", "-ubana", "-uco", "-uru", "-wa"}
