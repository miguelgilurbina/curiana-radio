...
**1779 ítems propuestos** en 32 propuestas, más **3 issue(s)/comentario(s) redactados sin publicar**.
...
| `toponimos_esteves_indice.yaml` | esteves-1989 | 164 |  |
...
| `lexicon_toponimos.py` | varias (F11) | 92 | lo importa migrar_toponimos |
