...
| `taino3_bachiller_morales_1883.yaml` | ? | 61 |  |
| `taino3_coll_y_toste_1897.yaml` | ? | 721 |  |
| `taino3_pane_bachiller_cotejo.yaml` | ? | 49 |  |
...
| `encargo-mineria-rivero.md` | Encargo de minería — Rivero 1883: los caquetíos del Casanare y el continuo achagua |
| `encargo-mineria-steward-hsai.md` | Encargo de minería — HSAI 4 y 5 (1948-1949): qué dice el *Handbook* de los caquetíos y de  |
