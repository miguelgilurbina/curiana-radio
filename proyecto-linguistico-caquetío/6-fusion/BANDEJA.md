...
**1817 ítems propuestos** en 32 propuestas, más **0 issue(s)/comentario(s) redactados sin publicar**.
...
| `toponimos_esteves_indice.yaml` | esteves-1989 | 132 |  |
...
| `lexicon_toponimos.py` | varias (F11) | 143 | lo importa migrar_toponimos |
