...
> cambios conocidos. Cada hecho del corpus (`3-mundo/corpus/ecologia.yaml`) lleva una de
...
> **Mapa** · [[mapa-ecologia]] — [[02_ecologia|hoja de fuentes]] — `ecologia.yaml` · `ecologia_lexicon_map.md`
...
mapa completo, entrada por entrada, está en `3-mundo/corpus/ecologia_lexicon_map.md`.
...
6. **Sincronizar clima → recurso → tensión.** La cadena real (estación → alisio → evaporación /
   ...
   `5-experimento/disenos/02_motor_ambiental.md`).
