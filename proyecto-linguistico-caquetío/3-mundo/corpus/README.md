# `3-mundo/corpus/` — Corpus cultural caquetío
...
entregables: un mini-ensayo (`3-mundo/ensayos/`), un archivo YAML aquí, y una hoja de fuentes
(`4-fuentes/sesiones/`).
...
|---|---|---|---|
| [`parentesco.yaml`](parentesco.yaml) | 1/4 — Familia | ¿Cómo era la familia caquetía? Matrilinealidad, matrimonio, sucesión, sociedades masculinas | [ensayo](../../3-mundo/ensayos/01_familia_caquetia.md) · [fuentes](../../4-fuentes/sesiones/01_familia.md) |
...
| [`ecologia.yaml`](ecologia.yaml) | 2/4 — Ecología | ¿Dónde existía el caquetío? Medio físico, geografía e hidrología del Golfete de Coro | [ensayo](../../3-mundo/ensayos/02_ecologia_golfete.md) · [fuentes](../../4-fuentes/sesiones/02_ecologia.md) |
| [`creencia.yaml`](creencia.yaml) | 3/4 — Creencia | ¿En qué creía el caquetío? Religión, muerte, piache, sistema onírico | [ensayo](../../3-mundo/ensayos/03_creencia_caquetia.md) · [fuentes](../../4-fuentes/sesiones/03_creencia.md) |
| [`transmision.yaml`](transmision.yaml) | 4/4 — Transmisión | ¿Cómo sabía lo que sabía? Currículo por edad, formas de transmisión, saberes restringidos, puntos únicos de falla | [ensayo](../../3-mundo/ensayos/04_transmision_saber.md) · [fuentes](../../4-fuentes/sesiones/04_transmision.md) |
| [`geografia_politica.yaml`](geografia_politica.yaml) | 5 — Geografía política | ¿Cuál era el área de influencia de Manaure, y qué asentamiento real reconstruimos? Apopo/diao/boratio, ABC+Paraguaná+Guajira, Todariquiba, escala poblacional | [ensayo](../../3-mundo/ensayos/05_geografia_politica_y_sucesion.md) · [fuentes](../../4-fuentes/sesiones/05_geografia_politica.md) |
...
- [`../../5-experimento/disenos/02_motor_ambiental.md`](../../5-experimento/disenos/02_motor_ambiental.md)
...
- [`../../5-experimento/disenos/02_capas_biosfera.md`](../../5-experimento/disenos/02_capas_biosfera.md)
...
- [`../../5-experimento/disenos/02_protocolo_habla_paraguanera.md`](../../5-experimento/disenos/02_protocolo_habla_paraguanera.md)
...
- [`../../4-fuentes/sesiones/PROGRAMA_WAYUU.md`](../../4-fuentes/sesiones/PROGRAMA_WAYUU.md) — programa de
