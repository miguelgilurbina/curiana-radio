...
| `curiana_sim/cultura/parentesco.yaml` | 39 hechos etiquetados (14 atestiguado · 18 reconstruido · 7 hipotético) |
| `curiana_sim/cultura/genealogia.yaml` | Linajes, agentes y personas de fondo propuestas — **pendiente de veto**, ver [[DECISIONES_ABIERTAS]] D1 |
...
- El linaje como **unidad residencial** → [[MOC_ecologia]] (bohíos, fogón) y
  [[MOC_geografia_politica]] (apopo = cabeza de linaje).
- La transmisión **por la línea materna** (el tío enseña quién eres) →
  [[MOC_transmision]].
- El segundo entierro y el osario del matrilinaje → [[MOC_creencia]].
- Los `rol_*` componibles propuestos (§6.6) → [[MOC_motor]], sin implementar.
