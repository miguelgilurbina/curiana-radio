...
- **Tabla de eventos rituales en el Observer** (paralela a `neologisms`) y la
  métrica de **eco por rol** — el experimento Bana-mana de [[MOC_transmision]].
...
- Los **9 huecos léxicos** de [[MOC_ecologia]] como candidatos sembrables.
- Los bloques `rol_*` componibles de [[MOC_familia]] §6.6.
