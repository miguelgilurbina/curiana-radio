...
| `curiana_sim/cultura/ecologia.yaml` | 45 hechos + **9 huecos léxicos** (54 entradas; 32 atestiguado · 21 reconstruido · 1 hipotético) |
| `curiana_sim/cultura/ecologia_lexicon_map.md` | Cross-check especie/rasgo → palabra caquetía → hueco, por 9 dominios |
...
3. **El *buco* no era una acequia de aldea**: era infraestructura regional
   (4-5 mil trabajadores para repararlo) → cruza con [[MOC_geografia_politica]].
...
[[MOC_motor]]: `hueco-lex-001` a `009` (médano, ictiofauna, viento ENE
