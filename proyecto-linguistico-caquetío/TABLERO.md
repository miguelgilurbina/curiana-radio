...
<!--GENERADO--> Generado el **2026-09-07 15:18**.
...
| Tests del motor | **241 en verde** | 0 rojos | 🟢 |
...
|  | Medido |  |
|---|---|---|
| Wikilinks | 1076 en 340 notas indexadas | 🟢 0 rotos |
| Tests (`curiana_sim/tests/`) | 241 passed, 0 failed | 🟢 |
