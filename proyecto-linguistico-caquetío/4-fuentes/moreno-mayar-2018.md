...
Paper sobre el **poblamiento temprano de América** (Beringia, dispersiones del
Pleistoceno tardío). Copia de DTU Orbit, 53 autores.
...
## Por qué esta nota se llamaba "Schroeder 2018" — 🟢 resuelto 2026-08-04

Durante meses el archivo se llamó
`Schroeder_et_al_2018_PNAS_Origins_Caribbean_Taino.pdf`, y **no era** el paper
de Schroeder et al. (PNAS 2018) sobre los orígenes del taíno caribeño. El
contenido real se verificó extrayendo la primera página.

Nadie llegó a citarlo — **0 hechos del corpus, 0 entradas del lexicón**. Si
...
Es el caso más limpio del argumento del vault: **el nombre de un archivo no es
un dato verificado.** El archivo ya está renombrado a
`MorenoMayar_et_al_2018_Science_Early_Human_Dispersals.pdf` (#54); esta nota
conserva el episodio porque el error tardó meses en detectarse.
