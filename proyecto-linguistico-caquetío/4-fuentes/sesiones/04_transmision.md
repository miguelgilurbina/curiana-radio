...
> [[mapa-transmision]] · [[04_transmision_saber|ensayo]] · [[INDICE_FUENTES]]
...
`3-mundo/ensayos/04_transmision_saber.md` y
`3-mundo/corpus/transmision.yaml`.
...
- **Cuadernillo *Pütchipü'üi, Palabrero Wayuu*** (Mincultura Colombia,
  ...
  levantamiento del programa aparte `4-fuentes/sesiones/PROGRAMA_WAYUU.md`
