...
**Cómo:** Barrido el glosario y cruzado con el lexicón (las voces caquetías atestiguadas de mar y las de creencia). Medido con `6-fusion/scripts/medir_cosmovision_marina.py`: `zavala2015`: 2 ventanas creencia × mar (2 con un nombre de la costa occidental cerca), 0 creencia × cielo de control.

**Se halló:** El léxico del mar (para, parawa, samuro, supi; kari, hoy hipotética) y el de la creencia (barsure, boratio, kana, kapu, kapo, kapubana, buio) NO se tocan: ninguna voz de creencia tiene glosa marina ni al revés.

**No se halló:** Cero intersección.
