...
([[MOC_transmision]]) que **no se pudo verificar en la fuente primaria**.

## Qué falta — **F9, y es más importante de lo que parece**

Todo el bloque `atestiguado` de [[MOC_creencia]] descansa sobre una cadena de
...
[[arcaya-1920]] · [[jahn-1927]] · [[oviedo-y-banos]] · [[MOC_creencia]] ·
